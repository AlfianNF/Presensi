  ...
  <div class="flex min-h-screen">
    <aside class="w-64 bg-[#034289] text-white flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
          <a href="#user" class="flex items-center px-3 py-2 rounded hover:bg-[#022e62]">
            <i class="fas fa-users mr-2"></i> User
          </a>
          <a href="#setting-presensi" class="flex items-center px-3 py-2 rounded hover:bg-[#022e62]">
            <i class="fas fa-cogs mr-2"></i> Setting Presensi
          </a>
          <a href="#presensi" class="flex items-center px-3 py-2 rounded hover:bg-[#022e62]">
            <i class="fas fa-calendar-check mr-2"></i> Presensi
          </a>
          <a href="#profil" class="flex items-center px-3 py-2 rounded hover:bg-[#022e62]">
            <i class="fas fa-user-circle mr-2"></i> Profil Admin
          </a>
        </nav>
        <div class="px-6 py-4 border-t border-[#022e62]">
          <button class="w-full text-left text-sm ">
